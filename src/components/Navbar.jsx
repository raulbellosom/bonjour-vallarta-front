        ...
        <div className="container-pad h-16 flex items-center justify-between gap-3">
          ...
          >
            ...
            <div className="flex flex-col leading-tight">
              <span className="text-sm sm:text-base font-bold text-[#5806a7] dark:text-white">
                {t("common.brand")}
              </span>
              <span className="text-[10px] sm:text-xs font-medium text-[#b6084f] dark:text-white">
                {t("common.slogan")}
              </span>
            </div>
          </Link>
          ...
          {open && (
            <>
              ...
              <motion.div
                ...
                className="fixed inset-0 bg-black/50 dark:bg-black/70 backdrop-blur-sm lg:hidden"
              ...
              <motion.div
                ...
                className="fixed right-0 w-full max-w-sm bg-white dark:bg-neutral-950 backdrop-blur-2xl border-l border-black/5 dark:border-white/10 shadow-2xl lg:hidden"
                style={{
                  zIndex: 9999,
                  top: "64px",
                  bottom: 0,
